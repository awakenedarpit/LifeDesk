...
export const TasksView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-3 sm:gap-4 lg:gap-5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="font-body-sm text-xs sm:text-sm text-on-surface-variant">
            Keep track of practicals, submissions, and academic milestones.
          </p>
        </div>
        <button
        ...
        {(
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-colors select-none ${
                isActive
      ...
      {/* Controls: Search, Category, Priority, Sort */}
      <div className="flex flex-col sm:flex-row gap-2.5 bg-surface-container-lowest p-3 rounded-2xl border border-surface-container">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full h-10 pl-9 pr-3 rounded-xl bg-surface-container-low text-sm outline-none text-on-surface focus:bg-surface-container transition-colors"
          />
        </div>
        ...
        <div className="grid grid-cols-3 sm:flex gap-2">
          <select
            ...
            className="h-10 px-2.5 rounded-xl bg-surface-container-low text-xs font-semibold text-on-surface outline-none border border-surface-container"
          >
        ...
        {filteredTasks.length === 0 ? (
          <div className="bg-surface-container-lowest rounded-2xl p-8 text-center border border-surface-container">
            ...
            <p className="font-body-sm text-xs sm:text-sm text-on-surface-variant mt-1">
              Create a new task or adjust your search filters above.
            </p>
            <button
              onClick={() => openModal('task')}
              className="mt-4 px-4 py-2 bg-primary text-on-primary rounded-xl text-xs font-bold shadow-xs"
            >
              + Create Task
            </button>
          </div>
          ...
          filteredTasks.map((task) => {
            ...
            return (
              ...
              >
                {/* Complete button (Touch friendly: 36px) */}
                <button
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <span className="font-label-xs text-xs text-on-surface-variant font-medium ml-auto flex items-center gap-1">
                  ...
                  <h3
                    className={`font-body-md text-sm sm:text-base text-on-surface font-semibold mt-1 ${
                  ...
                  {task.notes && (
                    <div className="mt-2 text-xs text-on-surface-variant bg-surface-container-low p-2 rounded-xl flex items-center gap-1.5 border border-surface-container/60">
                      <span className="material-symbols-outlined text-[15px] text-primary flex-shrink-0">note</span>
                  ...
                  {task.tags && task.tags.length > 0 && (
                    <div className="flex gap-1.5 mt-2 flex-wrap">
                      {task.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-[10px] px-2 py-0.5 rounded-md bg-surface-container-low text-on-surface-variant font-medium border border-surface-container/40"
                        >
                          #{tag}
                        </span>
                      ))}
                ...
                {/* Edit & Delete actions (Touch Friendly: min 36px) */}
                <div className="flex items-center gap-1 flex-shrink-0">
                  <button
                    aria-label="Edit task"
                    className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:bg-surface-container rounded-xl transition-colors"
                  ...
                  <button
                    ...
                    className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center text-on-surface-variant hover:text-error hover:bg-error-container/20 rounded-xl transition-colors"
